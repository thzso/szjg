    ...
    <div id={styles.container}>
      ...
      <div className={styles.cards}>
        ...
        <div className={styles.icons}>
          ...
          <ExternalLink
          url={"https://soundcloud.com/szgpostalada?fbclid=IwAR0CUOSZpk7mHpkfCgPRuz_9e3rrYYIAcOM6X2Nf--ILz1V5mk6dg8OVduQ"}
          >
            <img src={soundCloudLogo} alt="SoundCloud logo" className={styles.logo} />
          </ExternalLink>
...
Világok harca: a marsi invázió után
          ...
          <ExternalLink
          url={"https://www.kickstarter.com/projects/thelastarrival/the-last-arrival-iv-0"}
          >The Last Arrival</ExternalLink>
        </div>
      </div>
      <div className={styles.cards}>
        <h3>Blogs</h3>
        <div className={styles.textUrls}>
          <ExternalLink
          url={"https://szabo-j-gergely.blogspot.com/?fbclid=IwAR1EUtsIzL0aDeI00NHaYu0D1CHbyEFjg5tmGx1hcu5on2eVqX8IHP0aQv0"}
          >
            Fejezetek Lily és Sophie üzeneteiből
          </ExternalLink>

          <ExternalLink
          url={"https://modartel.blogspot.com/?fbclid=IwAR1tdbhT7APylRKnTA4ThAW4sA0rkiczxUXBa1ASkih4F0ENs-g7wSD9W4Y"}
          >
